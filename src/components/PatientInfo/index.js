...
const PatientInfo = (props) => {
  ...
  return (
    ...
    >
      <Card shadow="dark" className="w-600">
          ...
          {loading ? (
            ...
            <div>
              <div className="PatientInfo-heading">
                <Avatar appearance="primary">{`${data.name[0].given[0].charAt(0)}${data.name[0].family.charAt(
                  0
                )}`}</Avatar>
                ...
                <Row>
                  <Column {...columnOptions}>
                    <div className="PatientInfo-item">
                      ...
                      <Subheading appearance="subtle">
                        {data.maritalStatus ? data.maritalStatus.text : 'N/A'}
                      </Subheading>
                    </div>
                  </Column>
                  <Column {...columnOptions}>
